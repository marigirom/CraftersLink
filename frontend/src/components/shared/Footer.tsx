    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">CraftersLink</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Connecting talented artisans with designers to create exceptional custom pieces. 
              Empowering craftsmanship, one commission at a time.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/dashboard" className="hover:text-amber-500 transition-colors">
                  Dashboard
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/help" className="hover:text-amber-500 transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {currentYear} CraftersLink. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
